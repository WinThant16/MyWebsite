...
// Command: npx gltfjsx@6.2.16 space3d.gltf 
...
//   const { nodes, materials } = useGLTF(process.env.PUBLIC_URL + '/space3d.gltf')
//   return (
...
// useGLTF.preload(process.env.PUBLIC_URL + '/space3d.gltf')

import React, { useRef } from 'react';
import { useGLTF } from '@react-three/drei';
import { useFrame } from '@react-three/fiber';

export default function Space3d(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF(process.env.PUBLIC_URL + '/space3d.gltf');

  // Use the useFrame hook to rotate the group
  useFrame(() => {
